...
class DefaultController extends AbstractController
{
    ...
    /**
     * @Route("/listeCollections", methods={"GET"})
     */
    public function listeCollections(DocumentManager $dm, strutureVuesService $strutureVuesService, Request $request, $routeParams = array())
    {
        $entity = "collections";
            ...
            if (sizeof($tabT)) {
                ...
                foreach ($tabT as $t) {
                    ...
                    if (is_int($test)) {
                        ...
                        array_push($results[$test]['listeCollections'], $resto);
                    }
                }
            }
        }
        ...
        foreach ($results as $key => $resto) {
            ...
            if (sizeof($results[$key]['listeCollections']) == 0) {
                unset($results[$key]);
            }
        }
