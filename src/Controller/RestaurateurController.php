...
class RestaurateurController extends AbstractController
{
    ...
    /**
     * @Route("/api/restaurateur/delete/{id}", methods={"DELETE"})
     */
    ...
    /**
     * @Route("/api/restaurateur/upload", methods={"POST"})
     */
    ...
    /**
     * @Route("/api/restaurateur/download/{id}", methods={"GET"})
     */
    ...
    /**
     * @Route("/api/restaurateur/getImage/{id}", methods={"GET"})
     */
    ...
    /**
     * @Route("/api/restaurateur/update/{id}", methods={"POST"})
     */
    ...
    /**
     * @Route("/api/restaurateur/readAll/{entity}", methods={"GET"})
     */
    ...
    /**
     * @Route("/api/restaurateur/read/{id}", methods={"GET"})
     */
